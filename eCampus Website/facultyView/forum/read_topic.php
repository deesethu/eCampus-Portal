...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
		...
		<div class="box_left">
					...
					<a href="list_topics.php?parent=<?php echo $subID; ?>" style="font-size:110%;"><b> Topics</b></a>
		</div>
			<div class="clean"></div>
		</div>
<h1>title</h1>
...
if(isset($_POST['message']) and $_POST['message']!='')
{
	...
	$reply_insert=$reply->insert(array("parent"=>$subID,"tid"=>$tid,"id"=>$tid.$message,"id2"=>"","title"=>"","message"=>$message,"authorID"=>$_SESSION["fname"]));
	if($reply_insert == "1"){
		header('Location: http://localhost/ecampus/facultyView/forum/read_topic.php?tid='.$tid.'&parent='.$subID.'');
	}
}
else
{
