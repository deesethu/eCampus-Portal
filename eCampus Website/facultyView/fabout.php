<html>
	...
	<style type="text/css" media="screen">
		.hero-unit1{ padding: 60px;margin-bottom: 30px;background-color:#F0F0F0; -webkit-border-radius: 6px; -moz-border-radius: 6px; border-radius: 6px;}
	...
	<body>
					...
					<div class="container-fluid">
					  ...
					  <div class="nav-collapse collapse"><br>
						<ul class="nav">
							...
							<li class="active"><a href="#"><i class="icon-info-sign icon-white"></i> About us</a></li>
		...
		<div class="row-fluid" style="margin-top:10%;">
						<div class="span9">
							<div class="hero-unit1 pull-left">
								<h1>About us</h1><br>
								<p>
