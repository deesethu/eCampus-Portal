<html>
	...
	<style type="text/css" media="screen">
		...
		.btn-group1 .btn1 {float: left;margin-left: 19%;-webkit-border-radius: 0;-moz-border-radius: 0;border-radius: 0;}
        ...
        <div class="container-fluid">
		  ...
		  <div class="nav-collapse collapse"><br>
            <ul class="nav">
				...
				<li class="active"><a href="#"><i class="icon-envelope icon-white"></i> Contact us</a></li>
				<li><a href="help.php"><i class=" icon-question-sign icon-white"></i> Help</a></li>
					...
					<br><br><br><br>
						<h1><font color="#A1A1A1">Contact us</font></h1>
					</div>
					<div class="row">
						<div class="span8">
							<form action="" id="contactUs" class="form-horizontal">
								<fieldset>
