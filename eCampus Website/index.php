		  ...
		  <div class="nav-collapse collapse"><br>
            <ul class="nav">
				...
				<div class="row-fluid" style="margin-top:15%;">
					<div class="span5">
						<form class="form-horizontal" method="POST" id="user" action="userView/user1.php">
							<fieldset>
								<div id="legend">
									<legend class=""><font color="#A1A1A1">Student Login</font></legend>
								</div>
								<div class="control-group">
								<!-- Username -->
									<label class="control-label"  for="uname"><font color="#A1A1A1">Username</font></label>
										<div class="controls">
								...
								<!-- Button -->
									<div class="controls">
										...
										New User?<a href="register.php"><u> Click here</u></a>
									</div>
								</div>
								<center>Are you a faculty?<a href="facultyview/facultylogin.php"><u> Click here</u></a></center>
							<fieldset>
						</form>
					</div>
				</div>
