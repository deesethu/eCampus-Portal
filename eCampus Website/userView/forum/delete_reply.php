...
if(isset($_GET['parent'], $_GET['tid'], $_GET['id'] ))
{
	$subID = $_GET['parent'];
	$tid = $_GET['tid'];
	$id = $_GET['id'];
...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <title>Delete a reply- Forum</title>
		<!-- Le styles -->
...
<div class="box">
	<div class="box_left">
    	<a href="index1.php">Subject List</a> &gt; <a href="list_topics.php?parent=<?php echo subID; ?>">Topic List</a> &gt; Delete the reply
    </div>
    <div class="clean"></div>
</div>
<?php
if(isset($_POST['confirm']))
{
	...
	$reply_delete=$topic->remove(array("id"=>$id));
	echo $reply_delete;
	if($reply_delete == "1"){
...
<form action="delete_reply.php?parent=<?php echo $subID;?>&tid=<?php echo $tid;?>&id=<?php echo $id;?>" method="post">
