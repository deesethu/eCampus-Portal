...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <div class="content" style="margin-top:10%;">
		<div class="box">
			<div class="box_left">
				<a href="index1.php">Subject List</a> &gt;  Add a reply
			</div>
			<div class="clean"></div>
		</div>
		<?php
		if(isset($_POST['message']) and $_POST['message']!='')
		{
			...
			$reply_insert=$reply->insert(array("parent"=>$catID,"tid"=>$id,"id"=>"$id$message","id2"=>"","title"=>"","message"=>"$message"));
			if($reply_insert == "1"){
				header('Location: http://localhost/ecampus/userview/forum/read_topic.php?id='.$id.'&parent='.$catID.'');
			}
		}
		else
		{
		?>
		<form action="new_reply.php?id=<?php echo $id; ?>&parent=<?php echo $catID; ?>" method="post">
