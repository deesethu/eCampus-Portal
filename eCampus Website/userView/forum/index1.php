    ...
    <body>
      ...
      <div class="navbar-inner">
        <div class="container-fluid">
		  ...
		  <font size="8" face="Times New Roman" color="#926C44"><br>eCampus Portal</font>
      ...
      <div class="content" style="margin-top:10%;">
			<div class="box">
				...
				<div class="clean"></div>
			</div>	<a href="new_subject.php" class="button">Create a new Subject</a>
<table class="categories_table">
	...
	<?php 
		...
		echo '<tr>	
				...
				<div class="description">'.$subject_obj["description"].'</div></td>
					<td>';
				...
				echo '</td>';
				if($_SESSION["uname"]==$subject_obj["authorID"]){
				echo '<td><a href="delete_subject.php?id='.$subject_obj['id'].'"><img src="default/images/delete.png" alt="Delete" /></a></td>';
				}
				else
					echo '<td></td>';
		echo '</tr>';
