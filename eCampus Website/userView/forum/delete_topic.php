...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <title>Delete a topic - Forum</title>
		<!-- Le styles -->
...
<div class="box">
	<div class="box_left">
    	<a href="index1.php">Subject List</a> &gt; <a href="list_topics.php?parent=<?php echo $subID;?>">Topic List</a> &gt; Delete the topic
    </div>
    <div class="clean"></div>
</div>
<?php
if(isset($_POST['confirm']))
{
	...
	$topic_delete=$topic->remove(array("parent"=>$subID,"tid"=>$tid));
	if($topic_delete == "1"){
		header('Location: http://localhost/ecampus/userview/forum/list_topics.php?parent='.$subID.'');
	}
}
else
{
...
<form action="delete_topic.php?tid=<?php echo $tid; ?>&parent=<?php echo $subID; ?>" method="post">
